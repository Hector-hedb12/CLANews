...
*Nota 2*: existe un limite máximo de tweets que se pueden recolectar por tiempo,
...
```
java -cp dist/CLANews.jar clanews.tweetsanalyzer.TweetsAnalyzer -l <EN|ES> 
-m <message>
```
...
```
java -cp dist/CLANews.jar clanews.classifier.CLANews -l <EN|ES> -m <TRAIN|TEST> 
